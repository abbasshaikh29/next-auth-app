    ...
    <div className="container mx-auto p-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <p className="mb-4 text-red-600 font-medium">
          Add these URLs to your Google OAuth configuration in Google Cloud
          Console:
        </p>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <ol className="list-decimal pl-5 space-y-2">
          ...
          <li>
            Add the callback URLs listed above to the "Authorized redirect URIs"
            section
          </li>
          <li>
            Make sure your production domain is added to "Authorized JavaScript
            origins"
          </li>
